...
* [dropzone](https://www.dropzonejs.com/) 拖拽上传文件

## 拖拽drag-and-drop

* [sortable](https://github.com/SortableJS/Sortable) [官网](https://sortablejs.github.io/Sortable/)
* [draggable](https://github.com/Shopify/draggable) [官网](https://shopify.github.io/draggable/)
* [interact](https://github.com/taye/interact.js) [官网](https://interactjs.io/)
...
* [ckeditor](https://ckeditor.com/) 支持vue React Angular jquery
* [wangEditor](http://www.wangeditor.com/) [github](https://github.com/wangfupeng1988/wangEditor)
...
* [better-scroll](https://github.com/ustbhuangyi/better-scroll) 重点解决移动端滚动场景，借鉴iscroll，api兼容iscroll

### 浏览器环境

* [bowser](https://github.com/lancedikson/bowser) 浏览器检测工具

### 模板引擎

* [art-template](http://aui.github.io/art-template/zh-cn/) 浏览器和Node.js中都能使用
* [ejs](https://ejs.co/) [中文](https://ejs.bootcss.com/) 高效JavaScript模板引擎
